...
@require_once(dirname(__FILE__).'/tpl_functions.php');  // include hook for li_template functions
include_once(dirname(__FILE__).'/tpl_global.php');      // Include li_template global variables
...
<script async defer src="__LIQUID_PROTOCOL__://hypothesis.__LIQUID_DOMAIN__/embed.js"></script>
